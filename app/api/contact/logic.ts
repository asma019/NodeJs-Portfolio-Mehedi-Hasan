/**
 * Core logic for the contact API route.
 * Separated from the route handler to allow for easier testing without mocking Next.js internals.
 */
...
export async function handleContactRequest(
  ...
  const { NextResponse, nodemailer } = deps;
  try {
